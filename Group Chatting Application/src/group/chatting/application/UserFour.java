...
public class UserFour extends JFrame implements ActionListener, Runnable{
    ...
    UserFour(String name, int locx){
       ...
       JLabel l4 = new JLabel(uname+", Ali, Yatrik, Chokshi");
    ...
    public static void main(String[] args){
        UserFour one = new UserFour("Aakash", 750);
