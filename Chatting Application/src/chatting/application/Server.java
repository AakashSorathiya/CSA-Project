...
public class Server implements ActionListener{
    ...
    Server(){
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/dp.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            String out = t1.getText();
            //FileOutputStream fos = new FileOutputStream(new BufferedWriter());
            //BufferedWriter bw = new BufferedWriter(new FileWriter("F:\\New folder\\chatting-application-master\\chatting-application-master\\Chatting Application\\chat.txt", true));
